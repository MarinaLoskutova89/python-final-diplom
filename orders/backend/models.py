...
class Category(models.Model):
    shops = models.ManyToManyField(Shop, verbose_name='Магазин', related_name='categories', blank=True)
    name = models.CharField(max_length=50, verbose_name='Название')
...
class Contact(models.Model):
    type = models.CharField(max_length=100, verbose_name='Тип контакта')
